...
def main():
    ...
    testX, testY = load_data('/content/gdrive/My Drive/cz4042/test_batch_trim')
    ...
    for map1 in range(50, 131, 10):
        for map2 in range(50, 131, 10):
    ...
    y = range(50, 131, 10)
    X, Y = np.meshgrid(x, y)
    test_acc_mean=test_acc_mean.reshape(9,9)
    plt.figure()
    ...
    plt.savefig('/content/gdrive/My Drive/cz4042/figures/Grid_Search_Accuracy')
